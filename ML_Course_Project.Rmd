...
The data sets for this project are available in the below link:
...
```{r, eval=TRUE}
setwd("D:/CE/8-Practical Machine Learning/Project")
set.seed(1234)
...
plot(TrainTrainingSet$classe, col="orange", main="Plot of levels of variable classe within the TrainTrainingSet data set", xlab="classe", ylab="Frequency")
```
